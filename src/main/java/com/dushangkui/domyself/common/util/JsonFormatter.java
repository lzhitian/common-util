...
/**
 * Created by dushangkui on 2016/8/28.
 */
...
public class JsonFormatter {
    ...
    public static <T> T toObject(String json, TypeReference clazz, boolean serializeNull) throws JsonParseException, JsonMappingException, IOException {
        return getMapper(serializeNull).readValue(json, clazz);
    }
